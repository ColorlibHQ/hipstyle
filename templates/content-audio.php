...
?>
	...
	<article id="post_<?php the_ID(); ?>" <?php post_class('masonry__brick entry format-audio'); ?> data-aos="fade-up">
		...
		/**
		 * Blog Post Meta
		 * @Hook  hipstyle_blog_posts_meta
		 *
		 * @Hooked hipstyle_blog_posts_meta_cb
		 * 
		 *
		 */
		do_action( 'hipstyle_blog_posts_meta' );
		 ...
		 * @Hook  hipstyle_blog_posts_excerpt
		 *
		 * @Hooked hipstyle_blog_posts_excerpt_cb
		 * 
		 *
		 */
		do_action( 'hipstyle_blog_posts_excerpt' );
