    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = hipstyle_opt( 'hipstyle_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo hipstyle_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( hipstyle_featured_post_cat() ){
                                echo '<span class="entry__category">'.hipstyle_featured_post_cat().'</span>';
                            }
                            ?>
