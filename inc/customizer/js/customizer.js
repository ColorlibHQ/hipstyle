(function( $ , api){
    ...
    api.section( 'hipstyle_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'hipstyle_about_section' , function( section ){
    ...
    api.section( 'hipstyle_blog_section' , function( section ){
    ...
    api.section( 'hipstyle_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-hipstyle_contact_custom_formshortcode'),
                selector = $('#_customize-input-hipstyle_contact_formshortcode');
    ...
    // General section
    api.section( 'hipstyle_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#hipstyle_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-hipstyle_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-hipstyle_preloader_color' );
            ...
            var $backtotop          = $( '#hipstyle_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-hipstyle_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-hipstyle_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'hipstyle_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#hipstyle_footer_widget_toggle');
