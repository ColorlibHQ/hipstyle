...
// image default alt
if( !function_exists( 'hipstyle_img_default_alt' ) ){
	function hipstyle_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'hipstyle_img_tag' ) ){
	function hipstyle_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = hipstyle_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'hipstyle_anchor_tag' ) ){
	function hipstyle_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'hipstyle_heading_tag' ) ){
	function hipstyle_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'hipstyle_paragraph_tag' ) ){
	function hipstyle_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'hipstyle_other_tag' ) ){
	function hipstyle_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'hipstyle_button_element ' ) ){
	function hipstyle_button_element( array $args ){
