...
----------------------------------------*/
class hipstyle_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('hipstyle_instagram_photo',esc_html__('[ Hipstyle ] Intagram Photo','hipstyle'),array(
			'description' => esc_html__('Hipstyle Instagram Photo Widget','hipstyle'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'hipstyle');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'hipstyle'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'hipstyle'); ?></label>
...
if(!function_exists('hipstyle_instagram_widgets')):
	function hipstyle_instagram_widgets(){
		register_widget('hipstyle_instagram_photo');
	}
	add_action('widgets_init','hipstyle_instagram_widgets');
endif;
