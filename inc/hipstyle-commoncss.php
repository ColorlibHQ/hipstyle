...
// enqueue css
function hipstyle_common_custom_css(){
    
    wp_enqueue_style( 'hipstyle-common', get_template_directory_uri().'/assets/css/dynamic.css' );
		$header_bg         		  = esc_url( get_header_image() );
		$header_bg_img 			  = !empty( $header_bg ) ? 'background-image: url('.esc_url( $header_bg ).')' : '';

		$themeColor     		  = hipstyle_opt( 'hipstyle_theme_color' );
		$boxShadowColor    		  = hipstyle_opt( 'hipstyle_theme_box_shadow_color' );

		$buttonBorderColor     	  = hipstyle_opt( 'hipstyle_button_border_color' );
		$hoverColor     	  	  = hipstyle_opt( 'hipstyle_hover_color');

		$headerTop_bg     		  = hipstyle_opt( 'hipstyle_top_header_bg_color' );
		$headerTop_col     		  = hipstyle_opt( 'hipstyle_top_header_color' );

		$headerBg          		  = hipstyle_opt( 'hipstyle_header_bg_color');
		$menuColor          	  = hipstyle_opt( 'hipstyle_header_menu_color' );
		$menuHoverColor           = hipstyle_opt( 'hipstyle_header_menu_hover_color' );
		$otherPageMenuHoverColor  = hipstyle_opt( 'hipstyle_ohter_page_header_menu_hover_color' );
		$dropMenuColor            = hipstyle_opt( 'hipstyle_header_drop_menu_color' );
		$dropMenuHovColor         = hipstyle_opt( 'hipstyle_header_drop_menu_hover_color' );


		$footerwbgColor     	  = hipstyle_opt('hipstyle_footer_bg_color');
		$footerCopyBgColor     	  = hipstyle_opt('hipstyle_footer_copy_bg_color');
		$footerwTextColor   	  = hipstyle_opt('hipstyle_footer_widget_text_color');
		$widgettitlecolor  		  = hipstyle_opt('hipstyle_footer_widget_title_color');
		$footerwanchorcolor 	  = hipstyle_opt('hipstyle_footer_widget_anchor_color');
		$footerwanchorhovcolor    = hipstyle_opt('hipstyle_footer_widget_anchor_hover_color');
		
		$fofbg					  = hipstyle_opt('hipstyle_fof_bg_color');
		$foftonecolor			  = hipstyle_opt('hipstyle_fof_textone_color');
		$fofttwocolor			  = hipstyle_opt('hipstyle_fof_texttwo_color');
		...
		$customcss ="
			...
			.footer-area .single-footer-widget p, .footer-area .widget_hipstyle_newsletter .input-group input, .footer-area .copyright_part_text p, .footer-area .footer_2 .social_icon a, .copyright_part p
			{
				color: {$footerwTextColor}
			}
			.footer-area .widget_hipstyle_newsletter .input-group, .footer-area .copyright_part_text {
    ...
    wp_add_inline_style( 'hipstyle-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'hipstyle_common_custom_css', 50 );